...
const SECTION_SCHEMAS: Record<string, SectionSchema> = {
  ...
  calculators_section: {
    label: "Página Calculadoras",
    helper: "Textos, labels e botão da página /calculadoras. Há dois itens fixos: 'creatina' e 'tmb' — não remova, apenas edite os textos.",
    baseFields: [
      { key: "subtitle", label: "Etiqueta (acima do título)", type: "text", placeholder: "Ferramentas Horen" },
      { key: "title", label: "Título principal", type: "text", placeholder: "Calculadoras" },
      { key: "description", label: "Descrição", type: "textarea" },
    ...
    itemTitle: (item, idx) => item?.title || `Calculadora ${idx + 1}`,
    itemFields: [
      ...
      { key: "cta_size", label: "Tamanho do botão final (sm, default, lg)", type: "text", helper: "Edite apenas no primeiro item. Valores: sm, default, lg." },
      ...
      { key: "default_grams", label: "[Creatina] Valor inicial dose", type: "text" },
      { key: "default_stock", label: "[Creatina] Valor inicial pote", type: "text" },
      { key: "result_pre", label: "Texto antes do resultado", type: "text" },
      { key: "result_suffix", label: "Sufixo do resultado", type: "text" },
      { key: "result_end_label", label: "[Creatina] Label previsão", type: "text" },
      { key: "result_total_label", label: "[TMB] Label gasto total", type: "text" },
      { key: "label_sex", label: "[TMB] Label sexo", type: "text" },
      { key: "label_male", label: "[TMB] Botão masculino", type: "text" },
      { key: "label_female", label: "[TMB] Botão feminino", type: "text" },
      { key: "label_weight", label: "[TMB] Label peso", type: "text" },
      { key: "label_height", label: "[TMB] Label altura", type: "text" },
      { key: "label_age", label: "[TMB] Label idade", type: "text" },
      { key: "label_activity", label: "[TMB] Label atividade", type: "text" },
      { key: "opt_sedentary", label: "[TMB] Opção sedentário", type: "text" },
      { key: "opt_light", label: "[TMB] Opção leve", type: "text" },
      { key: "opt_moderate", label: "[TMB] Opção moderado", type: "text" },
      { key: "opt_active", label: "[TMB] Opção muito ativo", type: "text" },
      { key: "opt_extreme", label: "[TMB] Opção extremo", type: "text" },
    ],
  },
};
